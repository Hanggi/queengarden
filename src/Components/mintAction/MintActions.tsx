...
export default function MintActions({}: Props) {
  ...
  return (
    <div className="py-8">
      <div
        className="h-[56px] w-full rounded-[12px] xl:h-[64px] xl:rounded-[12px] bg-gray-300 border-[2px] border-gray-300 shadow-[4px_4px_0px_rgba(0,0,0,.1)] hover-btn-shadow flex justify-center items-center text-[21px] xl:text-[24px] leading-[21px] xl:leading-[24px] font-semibold min-w-[240px] xl:min-w-[260px]"
        onClick={() => {}}
      >
        Mint
      </div>
