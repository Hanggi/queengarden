...
const Sticky = () => {
  return (
    <>
      <div className="lg:sticky bottom-0 left-0 z-50 h-[88px] w-full flex items-center bg-black/80 px-[20px] 4xl:h-[112px] 4xl:px-[30px]">
        <div className="flex">
          <Image
            alt="now"
            width="20"
        ...
        <div className="ml-[30px] flex 4xl:ml-[50px] 5xl:ml-[100px] text-white">
          <Image
            alt="next"
            width="20"
            height="48"
        ...
        <div className="ml-[30px] flex 4xl:ml-[50px] 5xl:ml-[100px] text-[#FFD600]">
          <Image
            alt="next"
            width="20"
            height="48"
